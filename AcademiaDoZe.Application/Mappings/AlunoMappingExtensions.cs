...
public static class AlunoMappingExtensions
{
    public static AlunoDto ToDto(this Aluno aluno, Logradouro? logradouro = null)
    {
        ...
        return new AlunoDto
        {
            ...
            Senha = null, // Senha não deve ser exportada
    ...
    public static Aluno ToEntity(this AlunoDto alunoDto, Logradouro? logradouro = null)
    {
        ...
        Logradouro logradouroEntidade = logradouro
            ?? (alunoDto.Endereco != null ? alunoDto.Endereco.ToEntity() : null)
            ?? throw new InvalidOperationException("Logradouro (Endereço) obrigatório para converter Aluno.");
    ...
    public static Aluno UpdateFromDto(this Aluno aluno, AlunoDto alunoDto, Logradouro? logradouro = null)
    {
        ...
        Logradouro logradouroEntidade = logradouro
            ?? (alunoDto.Endereco != null ? alunoDto.Endereco.ToEntity() : null)
            ?? throw new InvalidOperationException("Logradouro (Endereço) obrigatório para atualizar Aluno.");

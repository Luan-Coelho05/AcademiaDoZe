...
public static class ColaboradorMappingExtensions
{
    ...
    public static Colaborador ToEntity(this ColaboradorDto colaboradorDto, Logradouro? logradouro = null)
    {
        ...
        Logradouro logradouroEntidade = logradouro
            ...
            ?? throw new InvalidOperationException("Logradouro (Endereço) obrigatório para converter Colaborador.");
    ...
    public static Colaborador UpdateFromDto(this Colaborador colaborador, ColaboradorDto colaboradorDto, Logradouro? logradouro = null)
    {
        ...
        Logradouro logradouroEntidade = logradouro
            ?? (colaboradorDto.Endereco != null ? colaboradorDto.Endereco.ToEntity() : null)
            ?? throw new InvalidOperationException("Logradouro (Endereço) obrigatório para atualizar Colaborador.");

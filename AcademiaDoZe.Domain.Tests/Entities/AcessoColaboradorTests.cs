...
public class AcessoColaboradorTests
{
    ...
    private static Colaborador GetValidColaborador() => Colaborador.Criar(1, "Fulano", "529.982.247-25", DateOnly.FromDateTime(DateTime.Today.AddYears(-30)),
        "(11) 91234-5678", "user@example.com", GetValidLogradouro(), "123", string.Empty, "Abcdef", GetValidArquivo(),
    ...
    [Theory(DisplayName = "AcessoColaborador: horário fora do intervalo -> DATA_HORA_INTERVALO_INVALIDO")]
    [InlineData(5, 59)]
    [InlineData(22, 1)]
    ...
    [InlineData(6)]
    [InlineData(22)]
    public void Deve_Permitir_HorariosDeBorda(int hour)
    {
        var colaborador = GetValidColaborador();

...
public class AcessoAlunoTests
{
    ...
    private static Aluno GetValidAluno() => Aluno.Criar(1, "João", "529.982.247-25", DateOnly.FromDateTime(DateTime.Today.AddYears(-20)),
        "(11) 91234-5678", "user@example.com", GetValidLogradouro(), "123", string.Empty, "Abcdef", GetValidArquivo()).Value!;
    ...
    [Theory(DisplayName = "AcessoAluno: horário fora do intervalo -> DATA_HORA_INTERVALO_INVALIDO")]
    [InlineData(5, 59)]
    [InlineData(22, 1)]
